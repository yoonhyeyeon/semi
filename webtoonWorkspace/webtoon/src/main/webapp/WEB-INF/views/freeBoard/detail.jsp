...
<body>
  <main>
    ...
    <div class="list">
      <div class="list_menu">자유게시판 >
        <button id="list_btn"><a href="/webtoon/board/freeBoard/list">목록</a></button>
      </div>
      <div id="title"><strong>${requestScope.vo.title}</strong></div>
      <div class="profile">
        <img id="profile_icon" src="/webtoon/resources/img/profile/고양이춘배.jpeg" alt="프로필아이콘">
    ...
    <br>
    <c:if test="${requestScope.vo.nick == sessionScope.loginMemberVo.nick}">
	    <div class="under">
