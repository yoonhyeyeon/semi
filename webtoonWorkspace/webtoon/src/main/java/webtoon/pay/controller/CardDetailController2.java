...
@WebServlet("/pay/cardDetail2")
public class CardDetailController2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.getRequestDispatcher("/WEB-INF/views/pay/cardDetail2.jsp").forward(req, resp);
